...
sudo $CURRENT_DIR/tools/bash/install-env-cf.sh

aws configure
$CURRENT_DIR/tools/bash/output-info.sh

touch $CURRENT_DIR/cf/RealTimeStack-packaged.yaml
sudo chmod 777 $CURRENT_DIR/cf/RealTimeStack-packaged.yaml

$CURRENT_DIR/tools/bash/deploy-stack-cf.sh