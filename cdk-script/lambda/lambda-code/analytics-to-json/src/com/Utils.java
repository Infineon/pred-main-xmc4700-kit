...
class Utils {
    ...
    private static final String TLE4964Hall_1 = "TLE4964Hall_1";            // < Hall Magnetic field value, tle4964
    ...
    private static final String TLE49611kHall_1 = "TLE49611kHall_1";   // < Double Hall Speed, tli4961
    ...
    public static JSONObject buildCommonJsonStructure() {
        ...
        json.put(TLE4964Hall_1, createValueMetrics());
    ...
    static JSONObject changeFinalJson(JSONObject inputJson) {
        ...
        fillMetrics(inputJson, finalJson, TLE4964Hall_1, "tle4964_hall_1_");
